...
public class StudentDB {
    ...
    public void addStudent(String firstName, String lastName, String email, Date enrolDate){
        try {
            ...
            preparedStatement.setDate(4, enrolDate);
    ...
    public static void main(String[] args) {
        ...
        studentDB.addStudent("Curtis", "Lopes", "myemail@myemail.com", Date.valueOf("2024-03-19"));
        studentDB.getAllStudents();
